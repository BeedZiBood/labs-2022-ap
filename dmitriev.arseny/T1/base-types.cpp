...
dmitriev::rectangle_t dmitriev::makeNewRect(point_t leftBott, point_t rightTop)
{
...
dmitriev::point_t dmitriev::multVec(point_t begin, point_t end, double k)
{
  return point_t{begin.x + (end.x - begin.x) * k,  begin.y + (end.y - begin.y) * k};
}

dmitriev::point_t dmitriev::sumVec(point_t a, point_t b)
{
